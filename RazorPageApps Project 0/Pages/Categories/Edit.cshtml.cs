...
public class EditModel : PageModel
{
    ...
    {
        if(NameOfTableCategory.Name == NameOfTableCategory.DisplayOrder.ToString()) // Custom server side validation checks specific condition prior to ModelState validation
        {
